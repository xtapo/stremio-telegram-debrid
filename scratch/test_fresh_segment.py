...
print("Fresh M3U8 length:", len(m3u8_text))
...
print("First segment URL:", first_segment[:120])

# 5. Fetch first segment URL
req3 = urllib.request.Request(first_segment, headers={'User-Agent': user_agent, 'Referer': embed_url})
res3 = urllib.request.urlopen(req3)
print("FRESH SEGMENT FETCH SUCCESS! Status:", res3.status, "Length:", len(res3.read()))
